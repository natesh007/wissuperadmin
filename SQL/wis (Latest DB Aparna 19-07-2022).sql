...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2022 at 05:29 PM
...
(5, 4, 1, 'vikarabad', 'dsads', '1.2', '1.3', 1, 1, '2022-07-18 05:22:56', 1, '2022-07-18 05:22:56');
...
(3, 'Temperature Too Hot1', 1, 1, 1, '2022-07-17 11:33:39', 1, '2022-07-17 11:33:39');
...
INSERT INTO `complaints` (`ComID`, `OrgID`, `BID`, `BKID`, `FID`, `RID`, `ComCatID`, `ComNatID`, `CustomComplaint`, `ComplaintPriority`, `ComplaintRemarks`, `ComplaintStatus`, `DeptID`, `CreatedBy`, `CreatedDate`, `UpdatedBy`, `UpdatedDate`) VALUES
(1, 1, 2, 1, 2, 1, 1, 1, '', 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent interdum nisl risus, eu rhoncus mi faucibus ac. Duis pretium faucibus odio, eu tincidunt nibh tempor vel. Etiam auctor metus diam, nec consequat dolor aliquet eu.', 1, 0, 1, '2022-07-19 20:58:05', 0, '2022-07-19 20:58:05');
...
(31, 0, 4, 5, 'IT Admin', 1, 1, '2022-07-18 05:23:44', 1, '2022-07-18 05:23:44');
...
(28, 0, 'test', 24, 4, 9, 'M', 'test1@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'test address', '98765432', 'permanent', '', '2022-01-01', '', '', '', 1, 1, '2022-07-18 05:25:24', 1, '2022-07-18 05:25:24');
...
INSERT INTO `floor` (`FID`, `OrgID`, `BKID`, `FloorName`, `Status`, `CreatedBy`, `CreatedDate`, `UpdatedBy`, `UpdatedDate`) VALUES
...
INSERT INTO `room` (`RID`, `OrgID`, `BKID`, `FID`, `RoomName`, `Status`, `CreatedBy`, `CreatedDate`, `UpdatedBy`, `UpdatedDate`) VALUES
...
--
ALTER TABLE `complaintnature`
  MODIFY `ComNatID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `employeebranches`
  MODIFY `EmpBrID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
