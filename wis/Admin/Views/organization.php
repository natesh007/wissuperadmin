                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 text-right add_user">
							<a href="<?= site_url('admin/organizations/add_organization') ?>" class="btn btn-success btn-background">Add New Organization</a>
						</div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
									...
									<div class="col-md-7">
										<form class="form-horizontal" action="" method="post">
											<div class="row">
												...
												<div class="col-md-3">
                                                    <span id="searchbtn"><a href="<?= base_url('admin/organizations/') ?>" class="btn btn-info field">Clear</a></span>
                                                </div>
											</div>
										</form>
									</div>
