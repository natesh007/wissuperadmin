...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Add Organization Designation</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <form class="form-horizontal" method="post" action="<?= base_url('admin/organizationdesignation/add_organizationdesignation') ?>" style="width:100%" id="add_organizationdesignation" method="post">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="Designation">Designation<strong class="help-block">*</strong></label>
                                    <input type="text" class="form-control" id="Designation" name="Designation" placehoder="Enter Designation" />
...
<script>
    $("#add_organizationdesignation").submit(function(event) {
