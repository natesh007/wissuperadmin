		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">Add Organization Deployment Type</h1>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
			</div>
			...
			<section class="content">
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								<form class="form-horizontal" method="post" action="<?= base_url('admin/organizationdeploymenttypes/add_organizationdeploymenttype') ?>" style="width:100%" id="add_organizationdeploymenttype" method="post">
									<div class="form-group row">
										<div class="col-md-6">
											<label for="DeploymentType">Deployment Type<strong class="help-block">*</strong></label>
											<input type="text" class="form-control" id="DeploymentType" name="DeploymentType" placehoder="Enter Deployment Type" />
		...
		<script>
			$("#add_organizationdeploymenttype").submit(function(event) {
