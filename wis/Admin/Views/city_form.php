			...
			<section class="content">
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								<form class="form-horizontal" method="post" action="<?= base_url('admin/cities/add_city') ?>" style="width:100%" id="add_city" method="post">
									<div class="form-group row">
										<div class="col-md-6">
											<label for="CityName">City Name<strong class="help-block">*</strong></label>
											<input type="text" class="form-control" id="CityName" name="CityName" placehoder="Enter city Name" />
		...
		<script>
			$("#add_city").submit(function(event) {
