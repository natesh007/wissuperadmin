								...
								<div class="row">
									...
									<div class="col-md-7">
										<form class="form-horizontal" action="" method="post">
											<div class="row">
												<div class="col-md-6">
													<input type="text" class="form-control field" name="key_word" placeholder="Enter name,email or mobile" id="key_word" value="<?php print $keyword; ?>">&nbsp;
												</div>
												<div class="col-md-2">
												&nbsp;<span id="searchbtn"><button type="submit" id="submit" name="submit" class="btn btn-sm btn-success field">search</button></span>
												</div>
												<div class="col-md-2">
                                                    <span id="searchbtn"><a href="<?= base_url('admin/employees/') ?>" class="btn btn-sm btn-info field">Clear</a></span>
                                                </div>
											</div>
										</form>
									</div>
