...
(function ($) {
  ...
  function createSkinBlock(colors, callback, noneSelected, isLightSideBar = 0) {
    var $block = $("<select />", {
      class: noneSelected
  ...
  $container.append('<h5>Customizations</h5><hr class="mb-2"/>');
  ...
  var $header_fixed_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $.cookie("layout-navbar-fixed", "ON");
    } else {
      $("body").removeClass("layout-navbar-fixed");
      $.cookie("layout-navbar-fixed", "OFF");
    }
  });
  ...
  if ($.cookie("layout-navbar-fixed") == "ON") {
    $("body").addClass("layout-navbar-fixed");
  ...
  var $sidebar_collapsed_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $.cookie("sidebar-collapse", "ON");
    } else {
      $("body").removeClass("sidebar-collapse");
      $(window).trigger("resize");
      $.cookie("sidebar-collapse", "OFF");
    }
  });
  ...
  /*var $sidebar_fixed_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $(window).trigger("resize");
      $.cookie("layout-fixed", "ON");
    } else {
      $("body").removeClass("layout-fixed");
      $(window).trigger("resize");
      $.cookie("layout-fixed", "OFF");
    }
  });
  ...
  if ($.cookie("layout-fixed") == "ON") {
    $("body").addClass("layout-fixed");
    $sidebar_fixed_checkbox.prop("checked", true);
  } else {
    $("body").removeClass("layout-fixed");
    $sidebar_fixed_checkbox.prop("checked", false);
  }*/
  ...
  var $sidebar_mini_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $.cookie("sidebar-mini", "ON");
    } else {
      $("body").removeClass("sidebar-mini");
      $.cookie("sidebar-mini", "OFF");
    }
  });
  ...
  if ($.cookie("sidebar-mini") == "ON") {
    $("body").addClass("sidebar-mini");
    $sidebar_mini_checkbox.prop("checked", true);
  } else {
    $("body").removeClass("sidebar-mini");
    $sidebar_mini_checkbox.prop("checked", false);
  }
  ...
  var $no_expand_sidebar_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $.cookie("sidebar-no-expand", "ON");
    } else {
      $(".main-sidebar").removeClass("sidebar-no-expand");
      $.cookie("sidebar-no-expand", "OFF");
    }
  });
  ...
  if ($.cookie("sidebar-no-expand") == "ON") {
    $(".main-sidebar").addClass("sidebar-no-expand");
  ...
  var $footer_fixed_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $.cookie("layout-footer-fixed", "ON");
    } else {
      $("body").removeClass("layout-footer-fixed");
      $.cookie("layout-footer-fixed", "OFF");
    }
  });
  ...
  if ($.cookie("layout-footer-fixed") == "ON") {
    $("body").addClass("layout-footer-fixed");
    $footer_fixed_checkbox.prop("checked", true);
  } else {
    $("body").removeClass("layout-footer-fixed");
    $footer_fixed_checkbox.prop("checked", false);
  }
  ...
  var $text_sm_body_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $.cookie("text_sm_body", "ON");
    } else {
      $("body").removeClass("text-sm");
      $.cookie("text_sm_body", "OFF");
    }
  });
  ...
  var $text_sm_header_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $.cookie("text_sm_header", "ON");
    } else {
      $(".main-header").removeClass("text-sm");
      $.cookie("text_sm_header", "OFF");
    }
  });
  ...
  var $text_sm_brand_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $.cookie("text_sm_brand", "ON");
    } else {
      $(".brand-link").removeClass("text-sm");
      $.cookie("text_sm_brand", "OFF");
    }
  });
  ...
  var $text_sm_sidebar_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $.cookie("text_sm_sidebar", "ON");
    } else {
      $(".nav-sidebar").removeClass("text-sm");
      $.cookie("text_sm_sidebar", "OFF");
    }
  });
  ...
  var $text_sm_footer_checkbox = $("<input />", {
    ...
    if ($(this).is(":checked")) {
      ...
      $.cookie("text_sm_footer", "ON");
    } else {
      $(".main-footer").removeClass("text-sm");
      $.cookie("text_sm_footer", "OFF");
    }
  });
  ...
  var navbar_light_skins = ["bg-light", "bg-warning", "bg-white", "bg-orange"];
  ...
  var $navbar_variants_colors = createSkinBlock(navbar_all_colors, function () {
    ...
    $.cookie("header_color", color);
  });

  var active_navbar_color = null;
  $(".main-header")[0].classList.forEach(function (className) {
    className = className.replace("navbar-", "bg-");
    if (
      navbar_all_colors.indexOf(className) > -1 &&
      active_navbar_color === null
    ) {
      active_navbar_color = className;
    }
  });
  if ($.cookie("header_color")) {
    $navbar_variants_colors
      .find("option." + $.cookie("header_color"))
      .prop("selected", true);
    $navbar_variants_colors
      .removeClass()
      .addClass("custom-select mb-3 text-light border-0 ")
      .addClass($.cookie("header_color"));
    $(".main-header").addClass($.cookie("header_color"));
  } else if (active_navbar_color) {
    $navbar_variants_colors
  ...
  var $sidebar_dark_variants = createSkinBlock(
    ...
    function () {
      ...
      $.cookie("dark_sidebar_color", color);
      $.removeCookie("light_sidebar_color");
      ...
      $.cookie("dark_sidebar_class", sidebar_class);
      $.removeCookie("light_sidebar_class");
  ...
  if ($.cookie("dark_sidebar_color")) {
    $sidebar_dark_variants
      .find("option." + $.cookie("dark_sidebar_color"))
      .prop("selected", true);
    $sidebar_dark_variants
      .removeClass()
      .addClass("custom-select mb-3 text-light border-0")
      .addClass($.cookie("dark_sidebar_color"));
    $(".main-sidebar")
      .removeClass("sidebar-dark-primary")
      .addClass($.cookie("dark_sidebar_class"));
  } else if (active_sidebar_dark_color !== null) {
    $sidebar_dark_variants
  ...
  var $sidebar_light_variants = createSkinBlock(
    ...
    function () {
      ...
      $.cookie("light_sidebar_color", color);
      $.removeCookie("dark_sidebar_color");
      $(this)
        .removeClass()
        .addClass("custom-select mb-3 text-light border-0 ")
        .addClass(color);
      ...
      $sidebar.removeClass("sidebar-dark-primary").addClass(sidebar_class);
      $.cookie("light_sidebar_class", sidebar_class);
      $.removeCookie("dark_sidebar_class");
  ...
  if ($.cookie("light_sidebar_color")) {
    $sidebar_light_variants
      .find("option." + $.cookie("light_sidebar_color"))
      .prop("selected", true);
    $sidebar_light_variants
      .removeClass()
      .addClass("custom-select mb-3 text-light border-0")
      .addClass($.cookie("light_sidebar_color"));
    $(".main-sidebar")
      .removeClass("sidebar-dark-primary")
      .addClass($.cookie("light_sidebar_class"));
  } else if (active_sidebar_light_color !== null) {
    $sidebar_light_variants
  ...
  if ($.cookie("brand_color")) {
    $brand_variants
      .find("option." + $.cookie("brand_color"))
      .prop("selected", true);
    $brand_variants
      .removeClass()
      .addClass("custom-select mb-3 text-light border-0 ")
      .addClass($.cookie("brand_color"));
    $(".brand-link").addClass($.cookie("brand_color"));
  } else if (active_brand_color) {
