...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Add Organization Site</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <form class="form-horizontal" method="post" action="<?= base_url('admin/organizationsite/add_organizationsite') ?>" style="width:100%" id="add_organizationsite" method="post">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="Site">Site<strong class="help-block">*</strong></label>
                                    <input type="text" class="form-control" id="Site" name="Site" placehoder="Enter Site" />
...
<script>
    $("#add_organizationsite").submit(function(event) {
        var Site = $('#Site').val();
