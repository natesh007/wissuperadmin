					...
					<div class="row">
						<form class="form-horizontal" method="post" action="" style="width:100%" enctype="multipart/form-data" id="edit_cats">
							...
							<div class="text-center form-group">
								<span><button type="submit" id="submit" name="submit" class="btn btn-success subcanbtn">Update</button></span>
								<span><a data-toggle="tooltip" title="Cancel" href="<?= base_url(); ?>/admin<?= session()->get('departments_page'); ?>" class="btn btn-primary subcanbtn">Cancel</a> </span>
							</div>
						</form>
					</div>
				</div>
